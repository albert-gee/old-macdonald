...
- Establish [](Matter.md) Fabrics and [commission](Node-Roles.md#commissioners) devices to join them.
...
### Project Configuration {collapsible="true"}
...
### Build Process Configuration {collapsible="true"}

```Bash
nano CMakeLists.txt
```

This configuration is based on the [ESP-Matter Controller](ESP-Matter-Controller.md) example with the following changes:
...
### Partition Table {collapsible="true"}
